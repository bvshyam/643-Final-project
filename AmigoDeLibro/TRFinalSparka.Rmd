...
dfbookratings <- read.csv("BX-CSV-Dump/BX-Book-Ratings.csv", header = TRUE, sep =";", stringsAsFactors = FALSE)
...
## Method for the UI 
getALSRecommendation <- function(user) {
     rectitle <- predict.ALS[,c(user)]
}

# TEST PREDICTION PER USER
getALSRecommendation(2524)
getALSRecommendation(325)
